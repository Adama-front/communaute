  ...
  const featuredArticles = [
    {
      ...
      excerpt:
        "Un investissement de 2,5 millions d'euros pour moderniser le cœur de notre ville avec des espaces verts et une fontaine interactive.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Le festival annuel met en lumière les talents de notre région avec trois jours de concerts gratuits.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "L'emploi local bénéficie de l'arrivée de startups innovantes dans la zone industrielle.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Un équipement moderne de 1000m² pour développer la pratique sportive locale.",
      image:
          ...
          <div className="lg:col-span-2">
            <Card className="news-card  h-full">
              ...
              <CardContent className="p-4 md:p-6">
                ...
                <div className="flex items-start md:items-center md:justify-between flex-col gap-y-2 md:flex-row">
                  <div className="flex items-center  space-x-4 text-sm text-gray-500">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span>
                        {formattedDates[mainArticle.publishedAt] || ""}
                      </span>
                    </div>
                  </div>
